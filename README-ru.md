...
- **АО Газстройпром** (апрель 2026 — наст. время) — фулстек-разработчик, взятие на поддержку проекта от ушедшего подрядчика
- **Самозанятость** (июль 2025 — май 2026) — AI-интеграции
