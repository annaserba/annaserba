# Привет! Я Анна — AI-разработчик, фронтенд и фулстек

[English version](./README.md)

## Опыт работы

- **АО Газстройпром** (апрель 2026 — наст. время) — фулстек-разработчик (React, Vite, Python), CI/CD, взятие на поддержку проекта от ушедшего подрядчика
- **Самозанятость** (июль 2025 — май 2026) — AI applier
- **[SuperJob](https://superjob.ru)** (июнь 2021 — июнь 2025) — команда работодательских интерфейсов (React, Node.js). Вела разработку спецпроектов для крупных работодателей: Сбер, ВТБ, Почта России, Перекрёсток. Дежурство за релизом, E2E-тестирование
- **Tenkites** (июнь 2016 — май 2021) — фулстек-разработчик (C#, PHP, jQuery), веб-меню для ресторанов
...
- Pixel Perfect вёрстка из Figma
- Адаптивная вёрстка
...
- **Севастопольский государственный университет** (2012 — 2016) — Информатика и вычислительная техника
...
- [Игра](https://dragon-speak-game.vercel.app)
